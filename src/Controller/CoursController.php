...
class CoursController extends AbstractController
{
     ...
     */
    public function favorisAddFront(Cours $cour,PaginatorInterface $paginator, Request $request){
     ...
     */
    public function favorisRemoveFront(Cours $cour,PaginatorInterface $paginator, Request $request){
